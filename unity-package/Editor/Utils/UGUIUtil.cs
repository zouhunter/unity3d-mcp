...
namespace UnityMcp.Tools
{
    ...
    {
        [MenuItem("GameObject/UFrame/UGUITool/AnchorsToCorners", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/UFrame/UGUITool/CornersToAnchors", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/UFrame/UGUITool/MirrorHorizontallyAnchors", priority = 0, validate = false)]
        public static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }
        [MenuItem("GameObject/UFrame/UGUITool/MirrorHorizontallyParent", priority = 0, validate = false)]
        ...
        [MenuItem("GameObject/UFrame/UGUITool/MirrorVerticallyAnchors", priority = 0, validate = false)]
        public static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }
        [MenuItem("GameObject/UFrame/UGUITool/MirrorVerticallyParent", priority = 0, validate = false)]
